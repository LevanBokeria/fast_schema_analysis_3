...
# ggsave(filename = 'block_1_2_barplot.png', plot = p, path = './results/plots/', width = 5, height = 3, device='png', dpi=300)
...
# ggsave(filename = 'learning_rates_all_cond.png', plot = p, path = './results/plots/', width = 4, height = 3, device='png', dpi=300)
```
